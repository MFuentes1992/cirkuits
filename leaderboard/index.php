...
<body class="leaderboard-section-body">
  ...
  <div class="container-fluid leaderboard-section-container">
    <h1 id="leaderboard-title">Leaderboard:&nbsp;<?=$videogameName?></h1>
    <br>
    <br>
    <div class="leaderboard-container">
        <div class="leaderboard-item">
          <div class="item-picture">
            <img src="<?=$url;?>img/avatars/<?= $_SESSION["user"]["avatar_usuario"] ?>.png" alt="avatar.png" class="img img-rounded" width="128px">
          </div>
          <div class="item-data">
            <div class="item-name">
