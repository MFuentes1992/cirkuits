<?php 
    ...
    session_start();
    if(isset($_SESSION["user"]) && isset($_GET["game"])) {
        ...
        switch(intval($_GET["game"])){
            ...
            break;
            case 2:
                header("Location:".$url."thesethose/level".$_SESSION["TheseThoseLevels"]["levels"]."/");
            break;
            case 3: 
                header("Location:".$url."tensemaster/level".$_SESSION["ToBeLevels"]["levels"]."/");
            break;
        }        
    }
?>  